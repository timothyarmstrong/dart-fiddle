...
$$.Editor = {"": "Object;canCreateDocuments,requiredSuffix,_root,_tabBar,_editorContainer,_statusBar<,_newButton,_activeDocument,_documents<,_filetypeToMode<",
  askForFilename$0: function() {
    var t1, t2, t3, filetype;
    t1 = {};
    t1.filename_0 = null;
    t2 = this._documents;
    do {
      $.scoped(new $.Editor_askForFilename_anon(t1));
      t3 = t1.filename_0;
    } while (t3 == null || t2.containsKey$1(t2, t3) === true);
    if ($.JSString_methods.endsWith$1($.toLowerCase$0$s(t1.filename_0), ".dart"))
      filetype = "Dart";
    else if ($.JSString_methods.endsWith$1($.toLowerCase$0$s(t1.filename_0), ".js"))
      filetype = "JavaScript";
    else {
      t1.filename_0 = $.S(t1.filename_0) + ".dart";
      filetype = "Dart";
    }
    return $.makeLiteralMap(["filename", t1.filename_0, "filetype", filetype]);
  },
  createDocument$4$renamable: function(_, filename, $content, filetype, renamable) {
    var t1, tab, t2, t3, aceElement, $document;
    t1 = {};
    tab = document.createElement("div");
    t2 = $.getInterceptor$x(tab);
    t3 = t2.get$classes(tab);
    t3.add$1(t3, "tab");
    tab.textContent = filename;
    t3 = t2.get$dataset(tab);
    t3.$indexSet(t3, "filename", filename);
    t2.set$title(tab, filename);
    t3 = this._tabBar;
    if (this.canCreateDocuments)
      t3.insertBefore(tab, t3.querySelector(".new"));
    else
      t3.appendChild(tab);
    t2.get$onClick(tab).listen$1(new $.Editor_createDocument_anon(this));
    t2.get$onDoubleClick(tab).listen$1(new $.Editor_createDocument_anon0(this, tab));
    aceElement = document.createElement("div");
    t2 = $.get$classes$x(aceElement);
    t2.add$1(t2, "editor");
    this._editorContainer.appendChild(aceElement);
    t1.aceProxy_0 = null;
    $.scoped(new $.Editor_createDocument_anon1(t1, this, $content, filetype, aceElement));
    $.scoped(new $.Editor_createDocument_anon2());
    $document = $._Document$(aceElement, tab, t1.aceProxy_0, filename, filetype, renamable);
    t1 = this._documents;
  ...
  createDocument$3: function($receiver, filename, content, filetype) {
    return this.createDocument$4$renamable($receiver, filename, content, filetype, true);
  },
  ...
  getDocumentsContents$0: function() {
    ...
    retval = $.List_List($);
    t1 = this._documents;
    t1.forEach$1(t1, new $.Editor_getDocumentsContents_anon(retval));
    return retval;
  },
  Editor$2$canCreateDocuments: function(_root, canCreateDocuments) {
    ...
    if (this.canCreateDocuments) {
      ...
      $.get$onClick$x(this._newButton).listen$1(new $.anon0(this));
    }
  }
};
...
$$.anon0 = {"": "Closure;this_0",
  call$1: function(e) {
    ...
    $.createDocument$3$x(t1, input.$index(input, "filename"), "", input.$index(input, "filetype"));
    t1.switchToDocument$1(input.$index(input, "filename"));
  }
};

$$.Editor_askForFilename_anon = {"": "Closure;box_0",
  call$0: function() {
    var filename = $.context().prompt$1("Filename?");
    this.box_0.filename_0 = filename;
  }
};
...
$$.Editor_createDocument_anon = {"": "Closure;this_1",
  call$1: function(e) {
    var t1, filename;
    t1 = $.get$dataset$x($.get$currentTarget$x(e));
    filename = t1.$index(t1, "filename");
    this.this_1.switchToDocument$1(filename);
  }
};

$$.Editor_createDocument_anon0 = {"": "Closure;this_2,tab_3",
  call$1: function(e) {
    var t1, filename, t2, $document, input, t3;
    t1 = $.get$dataset$x($.get$currentTarget$x(e));
    filename = t1.$index(t1, "filename");
    t1 = this.this_2;
    t2 = t1.get$_documents();
    $document = t2.$index(t2, filename);
    if ($document.get$renamable() === true) {
      input = t1.askForFilename$0();
      $.set$filename$x($document, input.$index(input, "filename"));
      $document.set$filetype(input.$index(input, "filetype"));
      t2 = this.tab_3;
      t2.textContent = input.$index(input, "filename");
      t3 = $.get$dataset$x(t2);
      t3.$indexSet(t3, "filename", input.$index(input, "filename"));
      $.set$title$x(t2, input.$index(input, "filename"));
      t1.get$_statusBar().textContent = input.$index(input, "filetype");
      t2 = t1.get$_documents();
      t2.remove$1(t2, filename);
      t1 = t1.get$_documents();
      t1.$indexSet(t1, input.$index(input, "filename"), $document);
    }
  }
};

$$.Editor_createDocument_anon1 = {"": "Closure;box_0,this_4,content_5,filetype_6,aceElement_7",
  call$0: function() {
    var aceProxy, t1, t2, t3;
    aceProxy = $.context().get$ace().edit$1(this.aceElement_7);
    t1 = this.box_0;
    t1.aceProxy_0 = aceProxy;
    t2 = t1.aceProxy_0.getSession$0();
    t3 = this.this_4.get$_filetypeToMode();
    t2.setMode$1(t3.$index(t3, this.filetype_6));
    ...
    $.setValue$1$x(t1.aceProxy_0, this.content_5);
...
$$.Editor_createDocument_anon2 = {"": "Closure;",
  call$0: function() {
  }
};
...
$$.Editor_getDocumentsContents__anon = {"": "Closure;document_1,data_2",
  call$0: function() {
    var t1 = this.data_2;
    t1.$indexSet(t1, "content", this.document_1.get$aceProxy().getValue$0());
  }
};
...
$$.main_anon0 = {"": "Closure;dartEditor_1,htmlEditor_2,runButton_3",
  call$1: function(e) {
    var data, request, t1, formData, statusMonitor;
    ...
    t1.open$2(request, "POST", "/api/save");
    t1.get$onLoadEnd(request).listen$1(new $.main__anon(request));
    formData = $.FormData_FormData($);
    $.append$2$x(formData, "data", $._JsonStringifier_stringify(data));
    request.send(formData);
    $.set$disabled$x(this.runButton_3, true);
    statusMonitor = document.querySelector("#result-panel .status-monitor");
    t1 = $.getInterceptor$x(statusMonitor);
    $.clear$0$ax(t1.get$children(statusMonitor));
...
$$.Object = {"": ";",
  ...
  append$2: function($receiver, $0, $1) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("append", "append$2", 0, [$0, $1], []));
  },
  ...
  createDocument$3: function($receiver, $0, $1, $2) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("createDocument", "createDocument$3", 0, [$0, $1, $2], []));
  },
  ...
  setValue$1: function($receiver, $0) {
...
$$._DataAttributeMap = {"": "Object;$$dom_attributes",
  containsKey$1: function(_, key) {
    ...
    return t1.containsKey$1(t1, "data-" + key);
  },
  $index: function(_, key) {
    var t1 = this.$$dom_attributes;
...
$$._LocalSendPortSync = {"": "Object;_liblib0$_receivePort",
  ...
  $eq: function(_, other) {
    if (other == null)
      return false;
    return typeof other === "object" && other !== null && !!other.$is_LocalSendPortSync && this._liblib0$_receivePort === other._liblib0$_receivePort;
  },
  get$hashCode: function(_) {
...
$.getId = function() {
  var path, t1;
  path = $.get$pathname$x($.get$location$x(window));
...
$.apiResponse = function(request) {
  var data, t1, id;
  $.set$disabled$x(document.querySelector("#run"), false);
  data = $.parse(request.responseText, null);
  t1 = $.getInterceptor$x(data);
  if (t1.containsKey$1(data, "error") === true) {
    window.alert(t1.$index(data, "error"));
    return;
  }
  id = t1.$index(data, "id");
...
$.statusResponse = function(request, token) {
  ...
  if (t1.$index(data, "last") !== true)
    ...
    t1.remove$1(t1, "active");
    $.set$src$x(document.querySelector("#result-panel iframe"), "/files/" + $.S($.getId()) + "/");
  }
};
...
$.sendStatusRequest = function(token) {
  ...
  request = new XMLHttpRequest();
  t1 = $.getInterceptor$x(request);
  t1.open$2(request, "GET", "/api/status/" + $.S(token));
  t1.get$onLoadEnd(request).listen$1(new $.sendStatusRequest_anon(token, request));
  request.send();
};

$._Document$ = function(editorElement, tabElement, aceProxy, filename, filetype, renamable) {
  return new $._Document(editorElement, tabElement, aceProxy, filename, filetype, renamable);
};
...
$.main = function() {
  var t1, dartEditor, t2, t3, t4, t5, htmlEditor, runButton;
  t1 = {};
  t1.initialData_0 = null;
  $.scoped(new $.main_anon(t1));
  dartEditor = $.Editor$(document.querySelector("#dart-code"), true);
  for (t2 = $.get$iterator$ax($.$index$asx(t1.initialData_0, "dart")); t2.moveNext$0();) {
    t3 = t2.get$current();
    t4 = $.getInterceptor$asx(t3);
    t5 = $.$eq(t4.$index(t3, "filename"), "main.dart");
    dartEditor.createDocument$4$renamable(dartEditor, t4.$index(t3, "filename"), t4.$index(t3, "content"), t4.$index(t3, "type"), t5 !== true);
  }
  htmlEditor = $.Editor$(document.querySelector("#html-code"), false);
  for (t1 = $.get$iterator$ax($.$index$asx(t1.initialData_0, "html")); t1.moveNext$0();) {
    t2 = t1.get$current();
    t3 = $.getInterceptor$asx(t2);
    htmlEditor.createDocument$4$renamable(htmlEditor, t3.$index(t2, "filename"), t3.$index(t2, "content"), t3.$index(t2, "type"), false);
  }
  runButton = document.querySelector("#run");
  $.get$onClick$x(runButton).listen$1(new $.main_anon0(dartEditor, htmlEditor, runButton));
  $.get$onClick$x(document.querySelector("#download")).listen$1(new $.main_anon1());
  $.get$onClick$x(document.querySelector("#save")).listen$1(new $.main_anon2());
  $.get$onClick$x(document.querySelector("#fork")).listen$1(new $.main_anon3());
};
...
$.append$2$x = function(receiver, a0, a1) {
  return $.getInterceptor$x(receiver).append$2(receiver, a0, a1);
};
...
$.createDocument$3$x = function(receiver, a0, a1, a2) {
  return $.getInterceptor$x(receiver).createDocument$3(receiver, a0, a1, a2);
};
...
$.setValue$1$x = function(receiver, a0) {
  return $.getInterceptor$x(receiver).setValue$1(receiver, a0);
};
...
$.$defineNativeClass("Element", {"": "$$dom_children:children=,id=,innerHtml:innerHTML},title}",
  get$attributes: function(receiver) {
...
$.$defineNativeClass("Entry", {
  ...
  remove$0: function(receiver) {
    ...
    this._liblib0$_remove$2(receiver, new $.Entry_remove_anon(completer), new $.Entry_remove_anon0(completer));
    return completer.future;
  }
});
...
$.$defineNativeClass("FormData", {
  append$3: function(receiver, $name, value, filename) {
...
$.$defineNativeClass("HTMLInputElement", {"": "disabled},src},type},value=",
  $isElement: function() {
    return true;
  },
  $asElement: function() {
...
$.$defineNativeClass("PagePopupController", {
  setValue$1: function(receiver, value) {
    return receiver.setValue(value);
  }
});
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,edit$1,eval$1,get$sb,then$1,get$_id,get$ace,get$_set,get$_tag,lookup$1,prompt$1,toJson$0,get$cause,process$0,_writeOn$1,callSync$1,get$_state,moveNext$0,register$2,set$_state,_callback$2,_dispatch$1,_sendData$1,exitScope$0,get$current,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,get$aceProxy,get$filetype,get$isWorker,get$sendPort,makeActive$0,set$filetype,toSendPort$0,unregister$1,_setGlobals$0,get$_callback,get$_duration,get$_registry,get$_workerId,get$renamable,get$_documents,get$_hashTable,get$_isolateId,get$_statusBar,get$stackTrace,makeInactive$0,runIteration$0,throwDelayed$0,_checkReplyTo$1,get$_futurePort,get$initialData,askForFilename$0,clearSelection$0,get$_receivePort,get$topEventLoop,get$_nextListener,get$_scopeIndices,get$nextIsolateId,set$_nextListener,set$nextIsolateId,get$currentContext,get$_filetypeToMode,_liblib0$_callback$1,get$_hasUnhandledError,get$_resultOrListeners".split(","), longNames = "call,call,call,call,call,edit,eval,sb,then,_id,ace,_set,_tag,lookup,prompt,toJson,cause,process,_writeOn,callSync,_state,moveNext,register,_state=,_callback,_dispatch,_sendData,exitScope,current,_handle=,_sendError,_sendValue,catchError,enterScope,aceProxy,filetype,isWorker,sendPort,makeActive,filetype=,toSendPort,unregister,_setGlobals,_callback,_duration,_registry,_workerId,renamable,_documents,_hashTable,_isolateId,_statusBar,stackTrace,makeInactive,runIteration,throwDelayed,_checkReplyTo,_futurePort,initialData,askForFilename,clearSelection,_receivePort,topEventLoop,_nextListener,_scopeIndices,nextIsolateId,_nextListener=,nextIsolateId=,currentContext,_filetypeToMode,_callback,_hasUnhandledError,_resultOrListeners".split(",");
